...
for iR=1:length(AllRusts)
    ...
    SummaryFilename=strcat(SubPlotFolderPath,'OverviewData_ET_',iRustStr,'.txt');
    ...
    TotalNumberSurveys=length(DataArray(:,1));
    ...
    TotalNumberSurveysNoSeverity=length(find(cell2mat(DataArray(:,11))==0));
    TotalNumberSurveysLowSeverity=length(find(cell2mat(DataArray(:,11))==1));
    TotalNumberSurveysModSeverity=length(find(cell2mat(DataArray(:,11))==2));
    TotalNumberSurveysHighSeverity=length(find(cell2mat(DataArray(:,11))==3));
    TotalNumberSurveysNoIncidence=length(find(cell2mat(DataArray(:,12))==0));
    TotalNumberSurveysLowIncidence=length(find(cell2mat(DataArray(:,12))==1));
    TotalNumberSurveysModIncidence=length(find(cell2mat(DataArray(:,12))==2));
    TotalNumberSurveysHighIncidence=length(find(cell2mat(DataArray(:,12))==3));
